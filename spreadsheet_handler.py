...
def process_spreadsheet(file_path):
    ...
    # Remover colunas que contenham apenas valores nulos
    result_df = result_df.dropna(axis=1, how='all')

    # Separa a coluna 'Grupo/Assunto' em 'Grupo' e 'Assunto'
    result_df[['Grupo', 'Assunto']] = result_df['Grupo/Assunto'].str.split('/', n=1, expand=True)
